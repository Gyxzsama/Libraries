	...
	<div class="am-cf admin-main">
		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on">增加用户信息</ul> &nbsp;&nbsp;
				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">增加用户</a> </dl>
			</div>
			<script type="text/javascript">
				function checkForm()
				{
					if(form1.readerName.value == ""){
						alert("书名不能为空");
						return false;
					}
					if(form1.readerPwd.value == ""){
						alert("作者不能为空");
						return false;
					}
					if(form1.readerContact.value == ""){
						alert("出版社不能为空");
						return false;
					}
					return true;
			...
			<div class="fbneirong">
				<form name="form1" method="post" action="${pageContext.request.contextPath}/AddReader.do" class="am-form" onsubmit="return checkForm()">
					<div class="am-form-group am-cf">
						
						<div class="zuo">用户名：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入用户名" name="readerName" value="">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">密码：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入密码" name="readerPwd" value="">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">联系方式：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入联系方式" name="readerContact" value="">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="you" style="margin-left: 11%;">
							...
							<button type="submit" class="am-btn am-btn-success am-radius" name="submit" value="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
							&nbsp;&nbsp;&nbsp;
							<button type="submit" class="am-btn am-btn-secondary am-radius" name="submit" value="3" onclick="back()">返回用户列表</button>
