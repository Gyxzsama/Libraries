	...
	<div class="am-cf admin-main">
		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on" >增加书籍信息</ul> &nbsp;&nbsp;
				<dl class="am-icon-home" style="float: right"> 当前位置： 首页 > <a href="#">增加书籍</a> </dl>
			</div>
			...
			<div class="fbneirong">
				<form name="form1" method="post" action="${pageContext.request.contextPath}/AddBook.do" class="am-form" onsubmit="return checkForm()">
					<div class="am-form-group am-cf">

						<div class="zuo">书名：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入书名" name="bookName" id="bookName">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">作者：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入作者" name="author" id="author">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">出版社：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入出版社" name="publisher" id="publisher">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">价格：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入价格" name="price" id="price">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">库存总量：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入库存" name="stock" id="stock">
						</div>
					</div>
					<div class="am-form-group am-cf">
						<div class="zuo">当前数量：</div>
						<div class="you">
							<input type="text" class="am-input-sm" placeholder="请输入数量" name="current" id="current">
						</div> 
					</div>
					...
					<div class="am-form-group am-cf">
						<div class="you" style="margin-left: 11%;">
							...
							<button type="submit" class="am-btn am-btn-success am-radius" name="submit" value="1">添加并继续</button>
							&nbsp;&nbsp;&nbsp;
							<button type="submit" class="am-btn am-btn-secondary am-radius" name="submit" value="2">添加并返回</button>
							&nbsp;&nbsp;&nbsp;
							<button type="submit" class="am-btn am-btn-secondary am-radius" name="submit" value="3" onclick="back()">返回书籍列表</button>
