	...
	<div class="am-cf admin-main">
		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on">删除用户信息</ul> &nbsp;&nbsp;
				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">删除用户</a> </dl>
		...
		<%-- 	<c:forEach items="${Book}" var="e">
			...
			<form method="post"  action="${pageContext.request.contextPath}/DeleteReader.do" class="am-form">
					...
					<div class="am-form-group am-cf">
						<div class="you" style="margin-left: 11%;">
							...
							<button type="submit" class="am-btn am-btn-success am-radius" name="submit" value="1">确认删除</button>
