	...
	<div class="am-cf admin-main">
		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on">查看用户信息</ul> &nbsp;&nbsp;  <ul style="color: #F00" class="am" > ${msg} </ul>
				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">查看用户信息</a> </dl>
				<!--data-am-modal="{target: '#my-popup'}" 弹出层 ID  弹出层 190行 开始  271行结束-->
			</div>
			<form  method="post" action="EditReader.do" class="am-form am-g">
				<table width="100%"
				...
				<!-- 此处的herf中的内容属于get操作，需要在servlet中使用doget操作转向dopost -->
					<li><a href="listReader.do?pageNo=1&pageSize=10">«</a></li>
					<li><a href="listReader.do?pageNo=${pageReader.prePage}&pageSize=10">上一页</a> </li>
					<li><a href="listReader.do?pageNo=${pageReader.nextPage}&pageSize=10">下一页</a></li>
					<li><a href="listReader.do?pageNo=${pageReader.lastPage}&pageSize=10">»</a> </li>
				</ul>
				<hr />
				<p></p>
			</form>
