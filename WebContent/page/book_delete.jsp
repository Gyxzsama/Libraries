	...
	<div class="am-cf admin-main">
		...
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				<ul class="am-icon-flag on">删除书籍信息</ul> &nbsp;&nbsp;
				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">删除书籍</a> </dl>
			</div>
		...
		<%-- 	<c:forEach items="${Book}" var="e">
			...
			<form method="post"  action="${pageContext.request.contextPath}/DeleteBook.do" class="am-form">
